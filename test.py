...
parser.add_argument('--volume_path', type=str, default='./All_Data/organ_npz', help='root dir for validation volume data')
...
parser.add_argument('--vit_name', type=str, default='Config', help='select one vit model')
...
if __name__ == "__main__":
    ...
    snapshot_name = snapshot_path.split(os.sep)[-1]
