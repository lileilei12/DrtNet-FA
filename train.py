...
parser.add_argument('--root_path', type=str,default=r"C:\FOLDER\code_project\EX\All_Data\npz_kidney_right", help='root dir for data')
parser.add_argument('--dataset', type=str, default='Synapse', help='experiment_name')
parser.add_argument('--list_dir', type=str, default=r"C:\FOLDER\code_project\EX\All_Data\list\kidney_right", help='list dir')
...
parser.add_argument('--patch_size', type=int, default=16, help='vit_patches_size, default is 32')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            'root_path': r"C:\FOLDER\code_project\EX\All_Data\npz_kidney_right",
            'list_dir': r"C:\FOLDER\code_project\EX\All_Data\list\kidney_right",
            'num_classes': 2,
        },
    }
    ...
    net = kidney_seg(config_vit, img_size=args.img_size).cuda()
